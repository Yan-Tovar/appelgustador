...
export default function DashboardEmpleadoLayout({ onLogout }) {
  ...
  const menuItems = [
    { text: "Inicio", icon: <HomeOutlined />, path: "/empleado" },
    { text: "Productos", icon: <Inventory2Outlined />, path: "/empleado/productos" },
