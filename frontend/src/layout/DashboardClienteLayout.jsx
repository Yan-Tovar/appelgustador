...
export default function DashboardClienteLayout({ onLogout }) {
  ...
  const menuItems = [
    { text: "Inicio", icon: <HomeOutlined />, path: "/cliente" },
    { text: "Carrito", icon: <ShoppingCartOutlined />, path: "/cliente/cart" },
    { text: "Pedidos", icon: <ViewStreamOutlined />, path: "/cliente/pedidos" },
    { text: "Facturas", icon: <ReceiptLongOutlined />, path: "/cliente/facturas" },
    { text: "Perfil", icon: <PersonOutline />, path: "/cliente/perfil" },
  ];
