...
import SearchBar from "../../components/features/SearchBarFacturas";
...
export default function Facturas() {
  ...
  const fetchInvoices = async () => {
    try {
      const res = await axios.get("http://127.0.0.1:8000/api/invoices/listarfacturas/", config);
